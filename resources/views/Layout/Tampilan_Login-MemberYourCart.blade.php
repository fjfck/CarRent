...
<div id = "Pokemon" style="width: 80%; display: table; margin: 0 auto;">
    ...
    <div style="width: 50%; display: inline-block; position: relative">
        ...
        <div class="Inner"><br><br>
            <div class="Inner-Judul">Your Cart</div>
            <img class="Inner-Logo" src="AssetProject/GitHub-Mark.png">

            <form method="POST" action="/FileUser">
                {{ csrf_field() }}
                <div id="MemberYourCartForm">



                    <br>
                    <tr>
                        <td>Total Quantity: </td><br>
                    </tr>

                    <tr>
                        <td>Total Price: </td><br>
                    </tr>

                    <tr>
                        <td><input type="submit" name="MemberYourCartsubmit" value="Complete the Payment"></td>
                    </tr>
