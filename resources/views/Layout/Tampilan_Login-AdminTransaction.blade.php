...
<div id="MenuNavigator">
    <a href="{{ROUTE('get.AdminPokemon')}}"><div class="Navigator">Search Car</div></a>
    <a href="{{ROUTE('get.AdminElement')}}"><div class="Navigator">All Car</div></a>
    <a href="{{ROUTE('get.AdminUser')}}"><div class="Navigator">User</div></a>
    <a href="{{ROUTE('get.AdminTransaction')}}"><div class="Navigator">Transaction</div></a>
    ...
    <div style="width: 50%; display: inline-block; position: relative">
        ...
        <div class="Inner"><br><br>
            ...
            <form method="POST" action="">
                ...
                <div id="AdminTransactionForm">
                    ...
                    <table border="1">
                        ...
                        @foreach($data_adminpokemon as $d_adminpokemon)
                            <tr>
                                <td>{{ $d_adminpokemon->NamePokemonData }}</td>
                                <td>{{ $d_adminpokemon->ElementPokemonData }}</td>
                                <td>{{ $d_adminpokemon->ColorPokemonData }}</td>
                                <td>{{ $d_adminpokemon->GenderPokemonData }}</td>
                                <td>{{ $d_adminpokemon->DescriptionPokemonData }}</td>
                            </tr>
                            <img src="" alt="">
            ...
            <tr>
                ...
                <a href="{{ROUTE('get.AdminUser')}}"><button name="AdminTransactionsubmit">Make a Request</button></a>
