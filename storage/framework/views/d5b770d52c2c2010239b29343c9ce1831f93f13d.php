...
<div id = "Pokemon" style="width: 80%; display: table; margin: 0 auto;">
    ...
    <div style="width: 50%; display: inline-block; position: relative">
        ...
        <div class="Inner"><br><br>
            <div class="Inner-Judul">Insert Element</div>
            <img class="Inner-Logo" src="AssetProject/Element_Image.png">

            <form method="POST" action="/doAddPokemonElementDB">
                <?php echo e(csrf_field()); ?>

                <div id="AdminElementForm">



                    <br>
                    <tr>
                        <td><input type="text" name="AdminElementNameElement" placeholder="Element Name"></td><br><br>
                    </tr>

                    <tr>
                        <button class="btn btn-success">INSERT ELEMENT</button>
                    </tr>
