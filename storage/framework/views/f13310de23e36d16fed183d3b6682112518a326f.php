...
<div id = "Pokemon" style="width: 80%; display: table; margin: 0 auto;">
    ...
    <div style="width: 50%; display: inline-block; position: relative">
        ...
        <div class="Inner"><br><br>
            <div class="Inner-Judul">Update User</div>
            ...
            <form method="POST" action="/FileUser">
                ...
                <div id="AdminUserForm">
                    ...
                    <br>
                    <tr>
                        <td><input type="text" name="AdminUserNameUser" placeholder="admin@admin.com"></td><br><br>
                    </tr>

                    <tr>
                        <td><input type="submit" name="AdminUsersubmit" value="Edit User"></td>
                    </tr>
